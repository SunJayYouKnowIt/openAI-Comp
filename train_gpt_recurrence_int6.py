"""
UPDAtED 2024-06-19: This is the main training script for the GPT recurrence challenge. It trains a small GPT-style model with recurrence and a custom optimizer, and evaluates on the provided validation set using a tokenizer-agnostic bits-per-byte metric.
